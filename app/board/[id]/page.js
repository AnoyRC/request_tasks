...
const Board = ({ params }) => {
  ...
  return (
    <div className="p-6 first-letter:bg-gray-100 min-h-screen">
                      ...
                      {column.id === "todo" && (
                        <>
                          <button
                            ...
                            className="flex items-center bg-primary opacity-70 text-secondary font-bold py-4 px-5 rounded-full text-xs w-5 h-3 justify-center"
                          >
                            <Edit2
                              size={16}
                              className="text-white absolute size-3"
                            />
                          </button>
                          <button
